...
class VideoController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->apiResponse(VideoResource::collection(Video::all()), 'Ok', JsonResponse::HTTP_OK);
    }
    ...
    public function store(VideoRequest $request)
    {
        ...
        $video->categories()->sync([$request->categoryname]);
        // $video = $this->test($request->validated());
        if ($video) {
            return $this->apiResponse($request, 'The video Save', JsonResponse::HTTP_CREATED);
        }
